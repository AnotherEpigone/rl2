...
namespace Roguelike2.Maps.Pathing
{
    /// <summary>
    ...
    public class McAStar
    {
        ...
        private List<Point> _subTileOffsets; // RL2 new subtile collection
        ...
        /// </param>
        public McAStar(IGridView<bool> walkabilityView, Distance distanceMeasurement)
            : this(walkabilityView, distanceMeasurement, new List<Point>(), null, null, 1.0)
        { }

        public McAStar(IGridView<bool> walkabilityView, Distance distanceMeasurement, IEnumerable<Point> subTileOffsets)
            : this(walkabilityView, distanceMeasurement, subTileOffsets, null, null, 1.0)
        { }
        ...
        public McAStar(IGridView<bool> walkabilityView, Distance distanceMeasurement, Func<Point, Point, double> heuristic)
            : this(walkabilityView, distanceMeasurement, new List<Point>(), heuristic, null, -1.0)
        { }
        ...
        /// </param>
        public McAStar(IGridView<bool> walkabilityView, Distance distanceMeasurement, IGridView<double> weights,
                     double minimumWeight)
            : this(walkabilityView, distanceMeasurement, new List<Point>(), null, weights, minimumWeight)
        { }
        ...
        public McAStar(IGridView<bool> walkabilityView, Distance distanceMeasurement, Func<Point, Point, double> heuristic,
            ...
            : this(walkabilityView, distanceMeasurement, new List<Point>(), heuristic, weights, -1.0)
        { }
...
#pragma warning disable CS8618 // _heuristic is initialized via Heuristic so ignore erroneous warning
        private McAStar(
            ...
            IEnumerable<Point> subTileOffsets,
            Func<Point, Point, double> heuristic = null,
            IGridView<double> weights = null,
...
#pragma warning restore CS8618
        ...
        // RL2 - logic replaced here to include subtile logic
        private bool CheckWalkability(Point pos, Point start, Point end, bool assumeEndpointsWalkable)
        {
            ...
            return tiles.All(p => WalkabilityView[p]);
        }
    }
